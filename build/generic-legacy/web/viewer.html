          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <button id="openFileInNewTab" class="toolbarButton" title="Open File in New Tab" tabindex="51" data-l10n-id="pdfjs-open-in-new-tab-button">
                  <span data-l10n-id="pdfjs-open-file-in-new-tab-button-label">Open</span>
                </button>
