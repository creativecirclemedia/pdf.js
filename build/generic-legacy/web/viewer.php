...
<script src="../build/pdf.js"></script>
  ...
  <body tabindex="1" id='mainBody'>
    <div id='iosFallback'>
      ...
      <h3>Attention iOS users</h3>
      <p>
        This e-reader is not compatible with your version of Apple's iOS operating system.
        Updating your device will correct this issue.
      </p>
      <p>
        Meanwhile, you can click the following link to browse directly to this document.
      </p>
      <p>
        <button type='button' onClick=" window.open(window.currentFile); ">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              ...
              <div id="toolbarViewerRight">
                ...
                <!-- <button id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" title="Switch to fullscreen view" tabindex="33" data-l10n-id="presentation_mode">
                  <span data-l10n-id="presentation_mode_label">Fullscreen view</span>
                </button> -->

                <button id="presentationMode" class="toolbarButton alternateFullscreen" title="Switch to fullscreen view 2" tabindex="33" data-l10n-id="presentation_mode" onClick=" window.open(window.currentFile); " >
                  <span data-l10n-id="presentation_mode_label">Full-screen view</span>
                </button>
